...
RUN $ wget -S -O - http://source.android.com/source/51-android.rules | sed "s/root/$USER/" | sudo tee >/dev/null /etc/udev/rules.d/51-android.rules; sudo udevadm control --reload-rules
